        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff; border-radius:10px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td align="center" style="padding:20px;">
                            ...
                            <h2 style="color:#f44336;">
                                {{ $reservation->status == 'confirmed' ? 'Reservation has been confirmed' : 'Reservation Pending, Please wait until confirmed' }}
                            </h2>
                    ...
                    <tr>
                        <td align="center" style="padding:20px;">
                            <p>Hi, <strong>{{ ucwords($reservation->guest_information->first_name) }} {{ ucwords($reservation->guest_information->last_name) }}</strong>. Please activate your account & use below password for login.</p>
                            ...
                            <p style="padding:10px; font-weight:bold;">Your password: {{$one_time_password}}</p>
                            @endif
                        </td>
                    </tr>
                    @endif
